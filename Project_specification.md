...
The aim of this project is to create a focused and detailed project, without using a lot of boilerplate code. The project should also be focused around frontend.
